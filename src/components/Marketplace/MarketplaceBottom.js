      ...
      <div className="marketplaceSorting">
        ...
        <div className="marketplaceNav">
          <Link
            ...
            className={
              tabMenuState === 1 ? "marketplaceLink active" : "marketplaceLink"
            }
          >
            All items
          </Link>
          <Link
            ...
            className={
              tabMenuState === 2 ? "marketplaceLink active" : "marketplaceLink"
            }
          >
            Art
          </Link>
          <Link
            ...
            className={
              tabMenuState === 3 ? "marketplaceLink active" : "marketplaceLink"
            }
          >
            Photography
          </Link>
          <Link
            ...
            className={
              tabMenuState === 4 ? "marketplaceLink active" : "marketplaceLink"
            }
          >
            Music
          </Link>
          <Link
            ...
            className={
              tabMenuState === 5 ? "marketplaceLink active" : "marketplaceLink"
            }
          >
            Video
          </Link>
