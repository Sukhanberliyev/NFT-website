		...
		<div className='modalCenter'>
			<div className='modal'>
				...
				<p className='connectWalletDescription'>
					You need to connect your wallet first to sign messages and send transaction to
					<br />
				...
				<button title='Close (Esc)' type='button' className='closeBtn' onClick={cancelHandler}>
...
const ConnectWallet = (props) => {
	return (
		<React.Fragment>
			...
			{ReactDOM.createPortal(
				<ConnectWalletOverlay onClose={props.onClose} onClick={props.cancelHandler} />,
