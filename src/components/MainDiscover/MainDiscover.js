...
import DiscoverData from "../../data/Discover/Discover.json";
        ...
        <div className="discoverTop">
          ...
          <div className="discoverNav">
            <Link
              ...
              className={
                tabMenuState === 1 ? "discoverLink active" : "discoverLink"
              }
            >
              All items
            </Link>
            <Link
              ...
              className={
                tabMenuState === 2 ? "discoverLink active" : "discoverLink"
              }
            >
              Art
            </Link>
            <Link
              ...
              className={
                tabMenuState === 3 ? "discoverLink active" : "discoverLink"
              }
            >
              Game
            </Link>
            <Link
              ...
              className={
                tabMenuState === 4 ? "discoverLink active" : "discoverLink"
              }
            >
              Photography
            </Link>
            <Link
              ...
              className={
                tabMenuState === 5 ? "discoverLink active" : "discoverLink"
              }
            >
              Music
            </Link>
            <Link
              ...
              className={
                tabMenuState === 6 ? "discoverLink active" : "discoverLink"
              }
            >
              Video
            </Link>
